...
const CONFIG = {
  ...
  primaryColor: "#1a5c6b",
  quickReplies: [
    { label: "Book appointment", icon: "📅", msg: "I'd like to book an appointment" },
    { label: "Insurance questions", icon: "🛡️", msg: "What insurance do you accept?" },
    { label: "I have a toothache", icon: "🦷", msg: "I have a toothache and need help" },
    { label: "Hours & location", icon: "📍", msg: "What are your hours and location?" },
  ],
};
...
export default function Widget() {
  ...
  return (
    <div style={S.root}>
      ...
      <button onClick={()=>setOpen(!open)} style={{...S.fab,...(open?{transform:"scale(0)",opacity:0,pointerEvents:"none" as const}:{})}} aria-label="Chat">
...
const styles: Record<string, React.CSSProperties> = {
  root:{position:"fixed",bottom:24,right:24,zIndex:99999,fontFamily:"'DM Sans',sans-serif",fontSize:14,lineHeight:"1.5",WebkitFontSmoothing:"antialiased"},
  ...
  fab:{width:58,height:58,borderRadius:"50%",border:"none",background:CONFIG.primaryColor,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 4px 20px rgba(0,0,0,.2)",transition:"transform .2s cubic-bezier(.16,1,.3,1),opacity .2s"},
};
